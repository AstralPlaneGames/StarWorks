...
namespace MoonWorks.Input
{
	...
	public static partial class InputEventEXT
	{
		...
		internal static void OnKeyDown(KeyCode key, ref SDL.SDL_Event evt)
		{
			if (KeyDown == null)
				return;
		...
		internal static void OnKeyUp(KeyCode key, ref SDL.SDL_Event evt)
		{
			if (KeyUp == null)
				return;
	...
	public class KeyEventArgs
	{
		...
		/// </summary>
		public KeyEventArgs(KeyCode key, bool alt, bool control, bool shift, bool gui = false)
		{
			Key = key;
			Alt = alt;
			Control = control;
	...
	public class KeyPressEventArgs
	{
		...
		/// </summary>
		public KeyPressEventArgs(KeyCode key, char keyChar)
		{
			Key = key;
			KeyChar = keyChar;
		}
	...
	public struct PointerEventArgs
	{
		...
		/// <remarks>The default mouse pointer will always be affected to the
		/// PointerId 0. On a tablet, a pen or each fingers will get a unique identifier.</remarks>
